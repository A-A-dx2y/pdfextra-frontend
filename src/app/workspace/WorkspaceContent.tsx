...
export default function Workspace() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex flex-col font-sans antialiased selection:bg-amber-500/20 selection:text-amber-255 relative overflow-hidden">
      
    
      <div className="absolute top-[-20%] left-[25%] w-[50%] h-[50%] bg-amber-955/15 rounded-full blur-[160px] pointer-events-none" />
            ...
            <div className="sticky bottom-6 left-0 right-0 z-30 max-w-3xl mx-auto px-4">
              <div className="bg-zinc-955/90 backdrop-blur-md border border-zinc-900 rounded-2xl p-4 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  <button
                    onClick={handleBackToSelection}
                    className="w-full sm:w-auto text-xs font-semibold px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-zinc-355 rounded-lg border border-zinc-800 transition active:scale-95 cursor-pointer"
                  >
                    Extract More Pages
                  </button>
                  <button
            ...
            <div className="bg-zinc-955/80 border border-zinc-900 rounded-xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="text-[11px] font-semibold px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-zinc-355 rounded-lg border border-zinc-800 transition cursor-pointer"
                >
                  Select All
                </button>
                <button
