...
export default function SignUp() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSubmitted(false);
      alert(`Account created successfully! Welcome to pdfextra, ${name}.`);
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex flex-col font-sans antialiased selection:bg-amber-500/20 selection:text-amber-250 relative overflow-hidden">
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-16 relative z-10">
        <div className="w-full md:w-[420px] bg-zinc-950/90 border border-zinc-850/80 rounded-2xl p-8 shadow-2xl backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="text-center space-y-2 pb-6 mb-6 border-b border-zinc-900">
            ...
            <p className="text-xs text-zinc-500">Get started free with pdfextra utility sandbox.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Full Name Field */}
            <div>
              <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold block mb-1.5">Full Name</label>
              <input
                type="text"
                value={name}
            ...
            {/* Password Field */}
            <div>
              <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold block mb-1.5">Password</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold block mb-1.5">Confirm Password</label>
              <input
                type="password"
